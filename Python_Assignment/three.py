...
import os
# Changed directory for listing all directory
os.chdir(r"C:\Users\prakshal.shah\eclipse-workspace")  

# function for displaying particular path and containig files
